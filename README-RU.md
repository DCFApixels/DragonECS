...
# Версионирование
В DragonECS применяется следующая семантика версионирования: major.minor.path
- `major`: глобальное обновление или обратно не совместимое обновление. После увеличения сбрасываются minor и path;
- `minor`: увеличивается при добавлении новой функциональности или большом обновлении, не нарушающих обратную совместимость;
- `path`: увеличивается при небольших обновлениях или багфиксах, не нарушающих обратную совместимость;
> `1.0.0` - минимальная релизная версия. 
> `0.x.x` - предрелизная версия, minor версии могут быть несовместимы.
# Основные концепции
## Entity

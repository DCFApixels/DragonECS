...
namespace DCFApixels.DragonECS
{
        ...
        struct entlong : IEquatable<long>, IEquatable<entlong>, IComparable<entlong>
    {
        ...
        public bool IsAlive
        {
            ...
            get
            {
                return EcsWorld.TryGetWorld(_world, out EcsWorld world) && world.IsAliveSafe(_id, _gen);
            }
        }
        ...
        public bool TryUnpack(EcsMask mask, out int id)
        {
            ...
            id = _id;
            return mask.World.IsAliveSafe(_id, _gen) && mask.World.IsMatchesMask(mask, _id);
        }
        ...
        public bool TryUnpack(EcsAspect aspect, out int id)
        {
            ...
            id = _id;
            return aspect.World.IsAliveSafe(_id, _gen) && aspect.IsMatches(_id);
        }

...
namespace DCFApixels.DragonECS
{
    ...
    {
        public static readonly MetaProxyBase EmptyProxy = new MetaProxyBase(typeof(void), typeof(void));
        public virtual bool IsInherit { get { return false; } }
        ...
        public MetaProxyBase(Type type, Type declaredType) { }
    }
}